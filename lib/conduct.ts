...
- **Ask before large moves.** Before broad discovery, synthesis, or multi-step analysis, ask the highest-information alignment question: what question, data, hypothesis, or analysis choice would change your next move? Prefer 2–4 choices when useful. Do not over-ask; if the answer is unlikely to matter, proceed and state the assumption.
...
- **State tradeoffs** instead of silently choosing for the scientist.`;
