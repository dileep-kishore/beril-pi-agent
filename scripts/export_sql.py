...
def _is_on_cluster() -> bool:
    ...
    Checks JupyterHub env vars first so the signal survives a project-local uv
    venv where ``berdl_notebook_utils`` is not importable; the import remains as
    a kernel-side fallback.
    """
